...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> 
        ...
        <a class="brand" href="index.html">Linux Dashboard </a>
...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="#"><i class="icon-dashboard"></i><span>General</span> </a> </li>
        <li><a href="#"><i class="icon-list-alt"></i><span>Disk</span> </a> </li>
        <li><a href="#"><i class="icon-facetime-video"></i><span>Applications</span> </a></li>
        <li><a href="#"><i class="icon-bar-chart"></i><span>Logs</span> </a> </li>
      </ul>
    </div>
    <!-- /container --> 
  </div>
            ...
            <div class="widget-content">
              <table class="table table-striped table-bordered">
                ...
                <th> Free Resource </th>
                  ...
                  </tr>who | cut -f1 -d " " | fgrep -f - somefile
                </thead>
                <tbody>
                  <tr>
